 ...
 * Makes a page secure.
 */
require_once '/membri/codetests/v4/common/google-api-php-client/src/Google/autoload.php';
require_once '/membri/codetests/v4/common/functions.php';
...
$client->setRedirectUri('http://codetests.altervista.org/v4/index.php');
